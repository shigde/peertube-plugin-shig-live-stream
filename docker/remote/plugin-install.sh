...
docker exec -it peertube-remoet peertube-cli plugins install --url 'http://remote-peertube.localhost:9002'  --username 'root' --password 'test' --path /usr/local/peertube-plugin-shig-live-stream

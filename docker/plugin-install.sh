...
docker exec -it peertube peertube-cli plugins install --url 'http://localhost:9000'  --username 'root' --password 'test' --path /usr/local/peertube-plugin-shig-live-stream
